...
To be a valid plugin a class must implement nl.mpi.flap.module.BaseModule and its class name must be listed in the file of the same name in META-INF.services. Any number of plugins can be listed in this file.